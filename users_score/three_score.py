...
def use_data_write( key_list ):
    name_dict = {}
    f = open( "three_score_data_name.txt", "w" )
...
class UsersThreeScoreFunction:
    ...
    def race_level_check( self, score ):
        ...
        if score == 2 or score == 4 or score == 5 or score == 6 or score == 7:
            return 5
    ...
    def foot_used( self, score ):
        ...
        if score == 4 or score == 5 or score == 7:
            return 5
