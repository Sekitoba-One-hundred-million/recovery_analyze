...
class Simulation():
    def __init__( self ):
        ...
        self.odds_key = { "one": "単勝", "quinella": "馬連", "trio": "三連複" }
    ...
    def simulation( self, learn_data, rate_data, kind, test = False ):
        ...
        for race_id in learn_data.keys():
            ...
            if not len( instance_list ) == 0:
                result.extend( self.function[kind]( instance_list, current_odds[self.odds_key[kind]] / 100 ) )
    ...
    def one( self, data, odds ):
        ...
        for i in range( 0, len( data ) ):
            ...
            result.append( { "score": score, "odds": od } )
